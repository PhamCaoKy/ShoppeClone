...
const hanldeConfirmPasswordYup = (refString: string) => {
  return yup
    .string()
...
export const schema = yup.object({
  ...
  password: yup
    ...
    .min(6, 'Độ dài từ 6 - 160 ký tự')
    .max(160, 'Độ dài từ 6 - 160 ký tự'),
  confirm_password: hanldeConfirmPasswordYup('password'),
...
export const userSchema = yup.object({
  ...
  confirm_password: hanldeConfirmPasswordYup('new_password')
})
